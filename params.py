...
arg('--img_height', type=int, default=600)
arg('--img_width', type=int, default=600)
arg('--out_height', type=int, default=600)
arg('--out_width', type=int, default=600)
arg('--input_width', type=int, default=320) #448
arg('--input_height', type=int, default=320)
